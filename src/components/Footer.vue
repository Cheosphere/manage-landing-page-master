...
const validateEmail = () => {
    ...
    if (!isValidEmail.value) {
        ...
        Swal.fire({
            title: '¡Success!',
            text: 'The email "' + email.value + '" has been entered correctly',
            icon: 'success',
        })
        email.value = ''
    }
    ...
    <footer class="footer">
        <div class="wrapper-footer">
            ...
            <form action="#" @submit.prevent="onSubmit">
                <div>
                    <input v-model="email" :class="{ errorinput: isErrorInput }" type="email"
                        placeholder="Updates in your inbox...">
                    <button @click="validateEmail" type="submit">Go</button>
                </div>
                <p v-if="!isValidEmail" :class="{ errortext: isErrorText }">Please insert a valid email</p>
